...
df_test.to_csv("../data/predictions/RobBERT_zeroshot_aspects_withoutDA.csv", sep=';')
...
df_output.to_csv('../classification_reports/classification_report_train_RobBERT_zeroshot_aspects.csv', sep=';')
...
df_output = pd.DataFrame(rounded_dict).transpose()
df_output.to_csv('../classification_reports/classification_report_test_RobBERT_zeroshot_aspects.csv', sep=';')
