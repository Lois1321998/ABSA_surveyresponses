...
class BERTClass(torch.nn.Module):
    def __init__(self):
        ...
        self.l1 = transformers.BertModel.from_pretrained('wietsedv/bert-base-dutch-cased', return_dict = False)
...
df_output.to_csv("../classification_reports/BERTje_fewshot_aspects_validation_withoutDA.csv", sep=';')
...
df_output.to_csv("../classification_reports/BERTje_fewshot_aspects_test_withoutDA.csv", sep=';')

df_test.to_csv("../data/predictions/BERTje_fewshot_aspects_test_withoutDA.csv", sep=';')
