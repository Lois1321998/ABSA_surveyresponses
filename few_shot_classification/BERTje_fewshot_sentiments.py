...
class ModelClass(torch.nn.Module):
    def __init__(self):
        ...
        self.model_layer = BertModel.from_pretrained('wietsedv/bert-base-dutch-cased')
...
EPOCHS = 10
LEARNING_RATE = 1e-05
tokenizer = BertTokenizerFast.from_pretrained('wietsedv/bert-base-dutch-cased')
...
#df_output.to_csv('../classification_reports/classification_report_validation_BERTje_fewshot_sentiments_withoutDA.csv', sep=';')
...
df_test.to_csv('../data/predictions/BERTje_fewshot_sentiments_withoutDA.csv', sep=';')
...
df_output = pd.DataFrame(rounded_dict).transpose()
#df_output.to_csv('../classification_reports/classification_report_test_BERTje_fewshot_sentiments_withoutDA.csv', sep=';')
